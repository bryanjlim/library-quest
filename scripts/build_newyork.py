...
<div id="about" class="modal-overlay">
  <div class="modal">
    ...
    <p>New York has <b>23 public library systems</b>, each with its own Libby catalog. Every card unlocks a different collection.</p>
    <p><b>Pro tip:</b> Any NYS resident can get free digital cards at <b>NYPL</b>, <b>Brooklyn</b>, and <b>Queens</b> &mdash; three of the largest Libby collections in the country.</p>
    <p><b>Dot color</b> = system type: Consolidated (NYC), Federated (county-led), or Cooperative (member libraries).</p>
    <p class="muted">Each pin is one library <b>system</b>. Click a dot for details. Progress saves in your browser.</p>
