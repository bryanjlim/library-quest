...
<div id="about" class="modal-overlay">
  <div class="modal">
    ...
    <p>Washington library systems form <b>reciprocal borrowing agreements</b> that let cardholders use partner libraries.</p>
    <p>Most smaller systems share one Libby catalog through the <b>WDLC</b> ("Washington Anytime Library"). The largest systems &mdash; KCLS, Seattle, Pierce County, Spokane &mdash; have their own independent Libby collections.</p>
    <p><b>Dot color:</b> Green = WDLC shared catalog. Grey = independent catalog.</p>
    <p class="muted">Each pin is a library <b>system</b> (one card per system). Click a dot for details. Progress saves in your browser.</p>
